...
// TODO : - Diviser la page en deux, une partie experience et une partie formation
const Experience = () => {
    return (
                    ...
                    <div className="experienceItem">
                        <div>
                            ...
                            <div>
                                ...
                                <p>- Gestion de projets d'intégration de systèmes en respectant les contraintes de temps, de budget et de qualité.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <p>- Développement d'applications web et mobiles en utilisant les dernières technologies et frameworks.</p>
                                <p>- Assurance de la qualité et de la performance des applications à travers des tests et des retours utilisateurs.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <p>- Participation à des projets de développement logiciel en équipe, en appliquant les méthodologies agiles.</p>
                                <p>- Acquisition de compétences en programmation informatique, en analyse de données et en gestion de bases de données.</p>
                            </div>
                        </div>
                    </div>
                    <div className="experienceItem ">
